...
/* harmony import */ var _client_home_client_home_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./client-home/client-home.component */ "./src/app/client-home/client-home.component.ts");
/* harmony import */ var _manager_home_manager_home_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./manager-home/manager-home.component */ "./src/app/manager-home/manager-home.component.ts");
...
/***/ "./src/app/client-home/client-home.component.css":
/*!*******************************************************!*\
  !*** ./src/app/client-home/client-home.component.css ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./src/app/client-home/client-home.component.html":
/*!********************************************************!*\
  !*** ./src/app/client-home/client-home.component.html ***!
  \********************************************************/
/*! no static exports found */
...
var ClientHomeComponent = /** @class */ (function () {
    ...
    ClientHomeComponent.prototype.sendBug = function () {
        var _this = this;
        if (this.bugData.software == 'other') {
            this.bugData.software = this.otherSoftware;
        }
        this.bugService.saveBug(this.bugData).subscribe(function (res) {
            console.log(res);
            _this.bugData = { software: "" };
        }, function (err) {
            console.log(err);
        });
    };
    ClientHomeComponent.prototype.getExtraTechnologies = function () {
        var _this = this;
...
/***/ "./src/app/coen174-service.service.ts":
/*!********************************************!*\
  !*** ./src/app/coen174-service.service.ts ***!
  \********************************************/
/*! exports provided: Coen174ServiceService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Coen174ServiceService", function() { return Coen174ServiceService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var Coen174ServiceService = /** @class */ (function () {
    function Coen174ServiceService(http) {
        this.http = http;
    }
    ...
    Coen174ServiceService.prototype.createAccount = function (body) {
        return this.http.post('https://protected-sea-43964.herokuapp.com/api/createAccount', body);
    };
    Coen174ServiceService.prototype.updateCode = function (body) {
    ...
    Coen174ServiceService.prototype.updateBugAssignment = function (body) {
        return this.http.post('https://protected-sea-43964.herokuapp.com/api/updateBugAssignment', body);
    };
    Coen174ServiceService.prototype.updateBugStatus = function (body) {
        return this.http.post('https://protected-sea-43964.herokuapp.com/api/updateBugStatus', body);
    };
...
var DeveloperHomeComponent = /** @class */ (function () {
    ...
    DeveloperHomeComponent.prototype.getAssignedBugs = function () {
        ...
        this.bugService.getAssignedBugs(email).subscribe(function (bugs) { return __awaiter(_this, void 0, void 0, function () {
            var i;
            return __generator(this, function (_a) {
                for (i = 0; i < bugs.bugs.length; i++) {
    ...
    DeveloperHomeComponent.prototype.getCommentsForBug = function (bug, index) {
        var _this = this;
        this.bugService.getComments(bug._id).subscribe(function (data) {
            ...
            _this.viewCommentToggles[index] = false;
        });
    };
    ...
    DeveloperHomeComponent.prototype.updateBugStatus = function (status, bugId) {
        var body = {
            status: status,
            id: bugId
        };
        this.bugService.updateBugStatus(body).subscribe(function (data) {
            console.log(data);
        });
    };
    DeveloperHomeComponent.prototype.addActiveBugComment = function (index) {
        var _this = this;
        var d = new Date();
        var comm = {
    ...
    DeveloperHomeComponent.prototype.addStatusUpdateComment = function (status, index) {
        var _this = this;
        var d = new Date();
        var comm = {
...
var ManagerHomeComponent = /** @class */ (function () {
    ...
    ManagerHomeComponent.prototype.getCommentsForBug = function (bug, index) {
        ...
        this.bugService.getComments(bug._id).subscribe(function (data) {
            if (bug.status != 'fixed') {
                _this.activeBugs[_this.activeBugs.length] = bug;
                _this.activeBugListeners[_this.activeBugListeners.length] = false;
                _this.viewCommentToggles[_this.viewCommentToggles.length] = false;
                _this.comments[_this.comments.length] = data.comments;
            }
        });
    };
    ...
    ManagerHomeComponent.prototype.updateBugAssignment = function (worker, bugId) {
        var body = {
            worker: worker,
            id: bugId
        };
    ...
    ManagerHomeComponent.prototype.updateBugStatus = function (status, bugId) {
        var body = {
            status: status,
            id: bugId
        };
    ...
    ManagerHomeComponent.prototype.delete = function (bug, index) {
        ...
        this.bugService.deleteBug(body).subscribe(function (data) {
            _this.activeBugs.splice(index, 1);
...
var NavBarComponent = /** @class */ (function () {
    ...
    NavBarComponent.prototype.viewCurrentBugs = function () {
...
module.exports = "<!--<div class=\"nav\">\n  <button (click)=\"navigate()\">Manage Account Codes</button>\n</div>-->\n<app-nav-bar></app-nav-bar>\n<div class=\"activeBugs\">\n  <h1>Bug History</h1>\n  <div class=\"sortOptions\">\n    <div class=\"filterItem\">\n      <label>Current Employee</label>\n      <select *ngIf=\"devs\" name=\"devDrop\" [(ngModel)]=\"filters.currentWorker\">\n          <option value=\"\"></option>\n          <option *ngFor=\"let dev of devs\" value=\"{{dev.email}}\">{{dev.name}} - {{dev.position}}</option>\n      </select>\n    </div>\n    <div class=\"filterItem\">\n      <label>Current Status</label>\n      <select name=\"statusDrop\" [(ngModel)]=\"filters.status\">\n          <option value=\"\"></option>\n              <option value=\"submitted\">Submitted</option>\n              <option value=\"verifying\">Verifying</option>\n              <option value=\"verified\">Verified</option>\n              <option value=\"fixing\">Fixing</option>\n              <option value=\"testable\">Ready For Test</option>\n              <option value=\"testing\">Testing</option>\n              <option value=\"fixed\">Fixed</option>\n      </select>\n    </div>\n    <div class=\"filterItem\">\n      <label>Software</label>\n      <select *ngIf=\"technologies\" name=\"techDrop\" [(ngModel)]=\"filters.software\">\n        <option value=\"\"></option>\n        <option *ngFor=\"let tech of technologies\" value=\"{{tech}}\">{{tech}}</option>\n      </select>\n    </div>\n    <div class=\"buttons\">\n      <button class=\"filterButton\" (click)=\"filterBugs()\">Filter</button>\n      <button class=\"filterButton\" (click)=\"getBugs()\">Clear Filters</button>\n    </div>\n  </div>\n  <table *ngIf=\"activeBugs\" class=\"BugTable\">\n    <tr>\n    \t<th>Date</th>\n    \t<th>Software</th>\n    \t<th>Cause</th>\n    \t<th>Description</th>\n    \t<th>Assigned To</th>\n    \t<th>Status</th>\n    \t<th>Comments</th>\n    \t<th>Add Comment</th>\n    \t<th>Delete</th>\n    </tr>\n    <tr *ngFor=\"let bug of activeBugs;index as i\">\n    \t<td>{{bug?.dateReported | date: 'M/d HH:mm'}}</td>\n    \t<td>{{bug?.software}}</td>\n    \t<td class=\"before\">{{bug?.before}}</td>\n    \t<td class=\"description\">{{bug?.description}}</td>\n    \t<td *ngIf=\"devs\">\n        <select name=\"devSelect\" [(ngModel)]=\"bug.currentWorker\" (change)=\"updateBugAssignment(bug.currentWorker, bug._id)\">\n          <option value=\"\"></option>\n          <option *ngFor=\"let dev of devs\" value=\"{{dev.email}}\">{{dev.name}} - {{dev.position}}</option>\n        </select>\n      </td>\n    \t<td>\n        <select *ngIf=\"bug?.status\" name=\"statusSelect\" [(ngModel)]=\"bug.status\" (change)=\"addStatusUpdateComment(bug.status, i); updateBugStatus(bug.status, bug._id)\">\n          <option value=\"\"></option>\n          <option value=\"submitted\">Submitted</option>\n          <option value=\"verifying\">Verifying</option>\n          <option value=\"verified\">Verified</option>\n          <option value=\"fixing\">Fixing</option>\n          <option value=\"testable\">Ready For Test</option>\n          <option value=\"testing\">Testing</option>\n          <option value=\"fixed\">Fixed</option>\n        </select>\n      </td>\n      <td>\n        <button (click)=\"viewCommentToggles[i] = !viewCommentToggles[i]\">View History</button>\n        <div *ngIf=\"comments\">\n          <div *ngIf=\"viewCommentToggles[i]\" class=\"viewComments\">\n            <ul>\n              <li *ngFor=\"let comment of comments[i];index as j\">\n                <span class=\"bold\">{{comments[i][j].dateAdded | date: 'M/d HH:mm'}}:</span> {{comments[i][j].comment}}\n              </li>\n            </ul>\n          </div>\n        </div>\n      </td>\n      <td>\n        <button (click)=\"activeBugListeners[i] = !activeBugListeners[i]\">Add Comment</button>\n        <div *ngIf=\"activeBugListeners[i]\" class=\"addComment\">\n          <textarea name=\"comment\" [(ngModel)]=\"newComment\"></textarea>\n          <button (click)=\"addActiveBugComment(i)\">Submit Comment</button>\n        </div>\n      </td>\n      <td><button (click)=\"delete(bug, i)\">Delete</button></td>\n    </tr>\n  </table>\n</div>\n"
...
var ViewAllBugsComponent = /** @class */ (function () {
    ...
    ViewAllBugsComponent.prototype.addStatusUpdateComment = function (status, index) {
        var _this = this;
        var d = new Date();
        var comm = {
            comment: "Bug changed to status: " + status,
    ...
    ViewAllBugsComponent.prototype.updateBugAssignment = function (worker, bugId) {
        var body = {
            worker: worker,
            id: bugId
        };
    ...
    ViewAllBugsComponent.prototype.updateBugStatus = function (status, bugId) {
        var body = {
            status: status,
            id: bugId
        };
    ...
    ViewAllBugsComponent.prototype.navToDeveloper = function () {
        this.router.navigate(['developer']);
    };
    ViewAllBugsComponent.prototype.delete = function (bug, index) {
        var _this = this;
        var body = {
            bug: bug
        };
